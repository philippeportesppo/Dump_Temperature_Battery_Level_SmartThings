...
preferences {
	...
	section("Configure your NAS MySQL server and credentials") {
    	input "serverURL", "text", title:"Server URL", defaultValue:"http://nashyphti2.myqnapcloud.com", required: true;
        input "serverPort", "text", title:"Server port", defaultValue:"8084", required: false
    }
}
